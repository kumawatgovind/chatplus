        ...
        <div class="card">
          ...
          <table class="table table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>
                      @if ($user->is_approved == 1)
                          <span class='btn1 btn-block btn-success btn-xs updateStatus text-center' style="width: 10%;" data-value="1" data-column="status">Approved</span>
                      @else
                          <span class='btn1 btn-block btn-danger btn-xs updateStatus text-center' style="width: 10%;" data-value="0">Disapproved</span>
                      @endif
                    </td>
                </tr>
                @endif
