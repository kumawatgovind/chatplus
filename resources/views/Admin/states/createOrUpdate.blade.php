    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            @if(isset($state))
            {{ Form::model($state, ['route' => ['admin.states.update', $state->id], 'method' => 'patch', 'id' => 'submit-state', 'files'=>'true']) }}
            @else
            {{ Form::open(['route' => ['admin.states.store'], 'id' => 'submit-state', 'files'=>'true']) }}
            @endif
            <div class="box-body">
              <div class="row">
