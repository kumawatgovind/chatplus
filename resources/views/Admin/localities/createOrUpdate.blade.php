...
<x-layouts.admin>
  ...
  <x-slot name="breadcrumb">
    <div class="row mb-2">
      ...
      <div class="col-sm-12">
        {{ Breadcrumbs::render('common',['append' => [['label'=> $title,'route'=> 'admin.localities.index'],['label' => !empty($locality) ? 'Edit '.$add : 'Add '.$add ]]]) }}
      </div>
    </div>
  </x-slot>
  <x-slot name="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            @if(isset($locality))
            {{ Form::model($locality, ['route' => ['admin.localities.update', $locality->id], 'method' => 'patch', 'id' => 'submit-locality', 'files'=>'true']) }}
            @else
            {{ Form::open(['route' => ['admin.localities.store'], 'id' => 'submit-locality', 'files'=>'true']) }}
            @endif
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group required {{ $errors->has('city_id') ? 'has-error' : '' }}">
                    ...
                    {{ Form::select('city_id', $cities, old('city_id'), ['class' => 'form-control','placeholder' => 'Select City']) }}
