...
<x-layouts.admin>
  ...
  <x-slot name="breadcrumb">
    <div class="row mb-2">
      ...
      <div class="col-sm-12">
        {{ Breadcrumbs::render('common',['append' => [['label'=> $title,'route'=> 'admin.cities.index'],['label' => !empty($city) ? 'Edit '.$add : 'Add '.$add ]]]) }}
      </div>
    </div>
  </x-slot>
  <x-slot name="content">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="{{ route('admin.cities.index') }}" class="btn btn-default pull-right" title="Cancel"><i class="fa fa-fw fa-chevron-circle-left"></i> Back</a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            @if(isset($city))
            {{ Form::model($city, ['route' => ['admin.cities.update', $city->id], 'method' => 'patch', 'id' => 'submit-city', 'files'=>'true']) }}
            @else
            {{ Form::open(['route' => ['admin.cities.store'], 'id' => 'submit-city', 'files'=>'true']) }}
            @endif
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group required {{ $errors->has('state_id') ? 'has-error' : '' }}">
                    ...
                    {{ Form::select('state_id', $states, old('state_id'), ['class' => 'form-control','placeholder' => 'Select State']) }}
            ...
            <div class="box-footer">
              ...
              <a href="{{ route('admin.cities.index') }}" class="btn btn-warning btn-flat" title="Cancel"><i class="fa fa-fw fa-chevron-circle-left"></i> Back</a>
            </div>
            {{ Form::close() }}
          </div>
          <!-- /.card-body -->
