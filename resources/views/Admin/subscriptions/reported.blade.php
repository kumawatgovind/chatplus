          ...
          <div class="card-body">
            <div class="filter-outer box box-info">
              ...
              <div class="box-body">
                ...
                {{ Form::open(['url' => route('admin.getNotPrime'),'method' => 'get']) }}
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    ...
                    <a href="{{ route('admin.getNotPrime') }}" class="btn btn-warning" title="Reset"><i class="fa  fa-refresh"></i> Reset</a>
                  </div>
                </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr class="row-{{ $user->id }}">
                  ...
                  <td>{{ $user->end_date ? date(config('get.ADMIN_ONLY_DATE_FORMAT'), strtotime($user->end_date)) : 'Not Available' }}</td>
