          ...
          <div class="card-body">
            <div class="filter-outer box box-info">
              ...
              <div class="box-body">
                ...
                {{ Form::open(['url' => route('admin.getTotalPrime'),'method' => 'get']) }}
                <div class="row">
                  ...
                  <div class="col-md-3 form-group">
                    ...
                    <a href="{{ route('admin.getTotalPrime') }}" class="btn btn-warning" title="Reset"><i class="fa  fa-refresh"></i> Reset</a>
                  </div>
                </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr class="row-{{ $user->id }}">
                  ...
                  <td>{{ $user->userSubscription->start_date ? date(config('get.ADMIN_ONLY_DATE_FORMAT'), strtotime($user->userSubscription->start_date)) : 'Not Available' }}</td>
                  <td>{{ $user->userSubscription->end_date ? date(config('get.ADMIN_ONLY_DATE_FORMAT'), strtotime($user->userSubscription->end_date)) : 'Not Available' }}</td>
