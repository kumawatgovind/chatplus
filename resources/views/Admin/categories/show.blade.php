...
@section('title', 'Category')
  ...
  <x-slot name="breadcrumb">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
      {{ Breadcrumbs::render('common',['append' => [['label'=> $getController,'route'=> 'admin.categories.index'],['label' => 'View  Category Detail']]]) }}
      </div>
    </div>
  </x-slot>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Admin Category Manager</h3>
          ...
          <table class="table table-hover table-striped">
               ...
               @endif
                ...
                <tr>
                    ...
                    <td>{{ $category->updated_at->format(config('get.ADMIN_DATE_FORMAT')) }}</td>
                </tr>                
            </table>
          </div>
