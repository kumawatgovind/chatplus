<x-layouts.admin>
  ...
  <x-slot name="content">
    ...
    <style>
      ...
      .form>div, #treeview {/*display: inline-block;*/vertical-align: top;}
      /*.form .dx-texteditor.dx-editor-outlined{width: 100% }*/
      .selected-container {padding: 20px;margin-left: 20px;font-size: 115%;font-weight: bold;}
      #selected-categories {margin-top: 0px; font-weight: 700;}
      /*#selected-categories .dx-list-item-content{ color:#28a745!important}*/
      .dx-list-item-content {padding-left: 0;}
      .options {padding: 20px;background-color: rgba(191, 191, 191, 0.15);margin-top: 20px;box-sizing: border-box;}
      .caption {font-size: 18px;font-weight: 500;}
      .option {width: 24%;display: inline-block; margin-top: 10px;margin-right: 5px;box-sizing: border-box;}
      .recursive-option {padding-left: 10px;}
      .option:last-of-type {margin-right: 0px;}

      .dx-treeview-with-search{ width:100%!important} 
    </style>
